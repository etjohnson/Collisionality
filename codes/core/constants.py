...
def const(
    ...
    const.encounter = 'E' + str(encounter)
    
    const.encounter_names = []
    const.encounter_names.append(const.encounter+'_protons.csv')
    const.encounter_names.append(const.encounter+'_alphas.csv')
    
    if const.error_files == True:
        const.encounter_names.append(const.encounter+'_proton_errors.csv')
        const.encounter_names.append(const.encounter+'_alpha_errors.csv')
